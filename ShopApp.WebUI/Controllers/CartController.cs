...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        {
            var order = new Order();
            order.OrderNumber ="BT"+(new Random()).Next(10000000, 99999999).ToString();
        ...
        private Payment PaymentProcess( OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-0mq3bQyxYl69ZNUctUaoGmRXq992k79g";
            options.SecretKey = "sandbox-BFOPaCdKK9hOSnhZ8gPCeKOaBb0ghEZU";
