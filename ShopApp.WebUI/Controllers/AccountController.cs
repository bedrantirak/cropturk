    ...
    public class AccountController : Controller
    {
        ...
        public async Task< IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //send email
                await _emailSender.SendEmailAsync(model.Email, " Üyelik Onayı", 
                    $"Hesap aktivasyonunuzu tamamladıktan sonra sisteme giriş yapabilirsiniz." +
                    $" Cropturk hesabını" +                   
                    $" <a href='http://localhost:56998{callbackUrl}'><button><strong>Onayla</strong></button></a>");                
        ...
        {           
            ...
            if (user==null)
            {
                ModelState.AddModelError("", "Bu hesap oluşturulmamış! Hemen kayıt olabilirsiniz.");
                return View(model);
            }
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            //send email
            await _emailSender.SendEmailAsync(Email, " Cropturk şifre yenileme",
                $"Cropturk parolanızı yenilemek için" +
                $" <a href='http://localhost:56998{callbackUrl}'><button>tıklayın</button></a>");
            TempData.Put("message", new ResultMessage()
            {
                Title="Forgot Password",
